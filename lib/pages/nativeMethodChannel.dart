...
class NativeMethodChannel extends StatefulWidget {
  const NativeMethodChannel({super.key});

  @override
  State<NativeMethodChannel> createState() => _NativeMethodChannelState();
}

class _NativeMethodChannelState extends State<NativeMethodChannel> {
